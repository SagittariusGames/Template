...
namespace TMPro
{
    ...
    public class SGUITMPTextEventHandler : MonoBehaviour, IPointerClickHandler
    {
        [Serializable]
        ...
        void Awake()
        {
            ...
            // Get a reference to the camera rendering
        ...
        void Click()
        {
            ...
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, positon, m_Camera))
            {

                #region Example of Character or Sprite Selection
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextComponent, positon, m_Camera, true);
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextComponent, positon, m_Camera);
                ...
                // Check if Mouse intersects any words and if so assign a random color to that word.
                int lineIndex = TMP_TextUtilities.FindIntersectingLine(m_TextComponent, positon, m_Camera);
                ...
                int linkIndex = TMP_TextUtilities.FindIntersectingLink(m_TextComponent, positon, m_Camera);
